...
If the request passes both exit checks, route to Exit C (Phase 3 plan drafting): question refinement (`references/question-writing.md`) → methodology selection (`references/methodology-selection.md`) → 6-field brief (`assets/default-brief.md`).
